<template>
  <div class="hello d-flex flex-nowrap">
    ...
    <div class="col d-flex flex-wrap">
      ...
      <div class="col-6 px-0 chart-block" id="secteurs_old">
        <div class="card">
          <div class="card-block">
            <h4 class="card-title text-left px-3 py-4">Top Entreprises (sur un total de {{ count.activities }})
              <i v-on:click="expandFrame('secteurs_old')" ref="secteurs_old" class="fa fa-expand float-right"></i></h4>
            <div id="chart1"></div>
          </div>
        </div>
      </div>
      <div class="col-6 pl-0 chart-block" id="secteurs">
        <div class="card">
          <div class="card-block">
            <h4 class="card-title text-left px-3 py-4">Top Secteurs d'Activités (sur un total de {{ count.industry }})
